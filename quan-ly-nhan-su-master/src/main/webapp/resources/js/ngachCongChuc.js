$(document).ready(function() {
		...
		$('#NgachCongChucTable tbody').on( 'click', 'button', function () {
			...
			if("btnUpdate" == id){
                    ...
                    var txtMaNgach = $(maNgach);
               	 	...
               	 	var txtVersion = $(version); 	 var txtpkbacluong = $(pkbacluong);
	            	$.ajax({  
	                    ...
	                    success: function (res) {
							 ...
							 txtpkbacluong.val(res.pkbacluong);	 txtVersion.val(res.version);
		                     $('#formNgachCongChuc').modal('show');
	                    }
	                });
			}	
    	...
    	$("button#btnCapNhap").click(function(e) {
			...
			json.pkbacluong = txtpkbacluong.val();
            if(txtPk.val() != -1){
    	...
    	$("button#btnDong").click(function(e) {
         	 var txtMaNgach = $(maNgach);
	       	 ...
	       	 txtTenNgach.val("");
	       	 txtSoNamNangBacLuong.val("");
				txtpkbacluong.val(res.pkbacluong);
        }); 
