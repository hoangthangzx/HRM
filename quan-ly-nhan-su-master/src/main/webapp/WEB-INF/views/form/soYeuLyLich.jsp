...
<form id="formTest" method="post" action="#" class="valida" autocomplete="off" novalidate="novalidate">
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<input class="form-control" id="congViecDuocGiao"  type="text">
		</div>
		<div class="col-md-3">
			<label for="chucDanh">Quyền hạn</label>
			<select style="height: 50px" class="form-control" id="chucDanh" name="chucDanh">
		...
		<div class="col-md-3">
			<div class="form-group">
				<label for="ngachCongChuc_pk">Chuyên Môn</label>
	...
	<div class="row">
		<div class="col-md-3">
			<label for="tenNgach" class="label-style">Tên chuyên môn</label> 
			<input class="form-control" id="tenNgach" type="text" readonly="readonly">
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="bacLuong_pk" class="label-style">Bậc lương</label> 
				<input class="form-control my-select-control-style" id="bacLuong_pk" required="true" onchange="changeBacLuong()"></input>
			</div>
		</div>
		<div class="col-md-3">
