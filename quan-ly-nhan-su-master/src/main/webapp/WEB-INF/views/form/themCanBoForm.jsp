				...
				<div class="panel-group">
					<form id="formThemCanBo" method="post" action="#" class="valida" autocomplete="off" novalidate="novalidate">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label for="donViChucNang_pkAdd">Phòng ban</label>
							...
							<div class="col-md-3">
								<div class="form-group">
									<label for="soHieuAdd" >Số hiệu nhân viên</label>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label for="tenAdd" class="label-style">Tên nhân viên</label> 
						...
						<div class="row">
							...
							<div class="col-md-3">
    <label for="chucDanhAdd">Quyền Hạn</label>
    <select style="height: 50px" class="form-control" id="chucDanhAdd" name="chucDanh">
        <option value="Nhân Viên">Nhân Viên</option>
        <option value="Giám Đốc">Admin</option>
    </select>
</div>
							
							<div class="col-md-3">
								<div class="form-group">
									<label for="ngachCongChuc_pkAdd">Chuyên môn</label>
									<c:if test="${not empty ngachCongChucLists}">
										<select class="form-control my-select-control-style"
											id="ngachCongChuc_pkAdd" onchange="changeNgachCongChucAdd()" onchange="changeBacLuongAdd()"
											required="true">
						...
						<div class="row">
							<div class="col-md-3">
								<label for="tenNgachAdd" class="label-style">Tên chuyên môn</label> 
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input class="form-control" id="bacLuong_pkAdd" type="text" >
								</div>
							</div>
							<div   class="col-md-3">
								<label for="heSoLuongAdd" class="label-style">Hệ Số Lương</label> 
								<input class="form-control" id="heSoLuongAdd" type="text" onchange="changeBacLuong()">
							</div>
							<div class="col-md-3">
