...
public class QuyetDinhKyLuatServiceImpl implements IQuyetDinhKyLuatService {
	...
	public ArrayList<QuyetDinhKyLuatDTO> getAll() {
	 ...
	 @Override
	    public List<QuyetDinhKyLuatDTO> findAllByCanBoPk(Integer canBoPk) {
	        List<Quyetdinhkyluat> listFromDb = repo.findAllByCanBoPk(canBoPk);
	        List<QuyetDinhKyLuatDTO> ketqua = new ArrayList<>();
