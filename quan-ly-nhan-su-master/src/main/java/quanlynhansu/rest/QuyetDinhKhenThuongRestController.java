...
public class QuyetDinhKhenThuongRestController {
	...
	public List<QuyetDinhKhenThuongDTO> getAll() throws SQLException {
	 ...
	 @GetMapping("/getAllByCanBoPk/{canBoPk}")
	    public List<QuyetDinhKhenThuongDTO> getAllByCanBoPk(@PathVariable Integer canBoPk) {
	        return quyetdinhkhenthuong.getAllByCanBoPk(canBoPk);
	    }
