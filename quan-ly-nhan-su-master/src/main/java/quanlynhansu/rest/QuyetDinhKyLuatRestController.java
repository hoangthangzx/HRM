...
public class QuyetDinhKyLuatRestController {
	...
	@GetMapping("/findAllByCanBoPk/{canBoPk}")
    public List<QuyetDinhKyLuatDTO> findAllByCanBoPk(@PathVariable Integer canBoPk) {
        return quyetdinhkyluat.findAllByCanBoPk(canBoPk);
    }
	@GetMapping("/getAll")
